<x-tools-com :toolsTitle="'Animista - Lap Tools Web'" toolsTitle="Animista" pageTitle="Animista" imageUrl="{{ asset('images/Dev/FrontEnd/AnimistaLogo.png') }}"
    toolsSubtitle="Animista is an online tool that lets developers create, customize, and experiment with CSS animations easily. It provides a library of ready-made animations like fades, bounces, slides, rotations, and zoom effects, which you can tweak by changing settings such as duration, delay, easing, and direction.
...
" videoUrl="{{ url('https://www.youtube.com/embed/Wzr9ZY_Ioec?si=lPNliGNns0iA_zCh') }}" websiteUrl="{{ url('https://animista.net') }}" androidUrl="" iosUrl="">
