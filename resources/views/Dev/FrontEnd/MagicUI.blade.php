<x-tools-com :toolsTitle="'MagicUI - Lap Tools Web'" toolsTitle="MagicUI" pageTitle="MagicUI" imageUrl="{{ asset('images/Dev/FrontEnd/MagicUILogo.jpg') }}"
    toolsSubtitle="MagicUI is an online tool that lets developers create, customize, and experiment with CSS animations easily. It provides a library of ready-made animations like fades, bounces, slides, rotations, and zoom effects, which you can tweak by changing settings such as duration, delay, easing, and direction.
...
" videoUrl="{{ url('https://www.youtube.com/embed/qh3NGpYRG3I?si=2Dd6MYdgnoo0f3oO') }}" websiteUrl="{{ url('https://magicui.design') }}" androidUrl="" iosUrl="">
