<x-tools-com :toolsTitle="'Uiverse.io - Lap Tools Web'" toolsTitle="Uiverse.io" pageTitle="Uiverse.io" imageUrl="{{ asset('images/Dev/FrontEnd/UiverseIoLogo.png') }}"
    toolsSubtitle="Uiverse.io is an online tool that lets developers create, customize, and experiment with CSS animations easily. It provides a library of ready-made animations like fades, bounces, slides, rotations, and zoom effects, which you can tweak by changing settings such as duration, delay, easing, and direction.
...
" videoUrl="{{ url('https://www.youtube.com/embed/EKXw22qBCOk?si=YKcUjb0a_XD0JRHd') }}" websiteUrl="{{ url('https://uiverse.io') }}" androidUrl="" iosUrl="">
